//#----- Test Procedure -----#
describe('Test 2 = add GO Ms Tree to favorites and check if it remains there', () => {
  before(() => {
    cy.visit('http://localhost:3000/')
  })

it("Find and click favorites, and check if the click  has an effect", () => { 
cy.get("[data-cypress='favorite-GO Ms Tree']").should('exist')
    .should('have.attr','title')
    .and('contain', 'Add to favourites')
cy.get("[data-cypress='favorite-GO Ms Tree']").first().click()
cy.get("[data-cypress='favorite-GO Ms Tree']")
    .should('have.attr','title')
