//#----- Test Procedure -----#
describe('Test 2 = add Elsbeth III to favorites and check if it remains there', () => {
  before(() => {
    cy.visit('http://localhost:3000/')
  })

it("Find and click favorites, and check if the click  has an effect", () => { 
cy.get("[data-cypress='favorite-Elsbeth III']").should('exist')
    .should('have.attr','title')
    .and('contain', 'Add to favourites')
cy.get("[data-cypress='favorite-Elsbeth III']").first().click()
cy.get("[data-cypress='favorite-Elsbeth III']")
    .should('have.attr','title')
